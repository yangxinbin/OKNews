package com.baihui.yangxb.startpage.utils;
    ...
    public void start(final TitanicTextView textView) {
        ...
        final Runnable animate = new Runnable() {
            ...
            public void run() {
                ...
                ObjectAnimator maskXAnimator = ObjectAnimator.ofFloat(textView, "maskX", 0, 80);
                maskXAnimator.setRepeatCount(ValueAnimator.INFINITE);
                maskXAnimator.setDuration(400);
                ...
                maskYAnimator.setRepeatMode(ValueAnimator.REVERSE);//往返
